import { TableCellAlignmentStyle } from "../enumerations/table-cell-align-style";
import { TableCellBorderStyle } from "./table-cell-border-style";
import { TableCellVerticalAlignmentStyle } from "../enumerations/table-cell-vertical-align-style";
/**
